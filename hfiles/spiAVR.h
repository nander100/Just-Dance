...
// const unsigned int font[96][10] ={
//     {0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000}, // ' ' (space)
//     {0x0000, 0x0000, 0x7C00, 0x7C00, 0x7C00, 0x7C00, 0x7C00, 0x0000, 0x7C00, 0x0000}, // '!'
//     {0x0000, 0x6600, 0x6600, 0x6600, 0x6600, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000}, // '"'
//     {0x0000, 0x3600, 0x3600, 0xFF00, 0x3600, 0xFF00, 0x3600, 0x3600, 0x0000, 0x0000}, // '#'
//     {0x0000, 0x1800, 0x7E00, 0xC300, 0xC000, 0x7E00, 0x0300, 0xC300, 0x7E00, 0x1800}, // '$'
//     {0x0000, 0x0000, 0xC600, 0xCC00, 0x1800, 0x3000, 0x6600, 0xC600, 0x0000, 0x0000}, // '%'
//     {0x0000, 0x3800, 0x6C00, 0x6C00, 0x3800, 0x6D80, 0xC700, 0xC700, 0x6D80, 0x0000}, // '&'
//     {0x0000, 0x6000, 0x6000, 0x6000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000}, // '''
//     {0x0000, 0x1800, 0x3000, 0x6000, 0x6000, 0x6000, 0x6000, 0x3000, 0x1800, 0x0000}, // '('
//     {0x0000, 0x6000, 0x3000, 0x1800, 0x1800, 0x1800, 0x1800, 0x3000, 0x6000, 0x0000}, // ')'
//     {0x0000, 0x0000, 0x0000, 0x6600, 0x3C00, 0xFF00, 0x3C00, 0x6600, 0x0000, 0x0000}, // '*'
//     {0x0000, 0x0000, 0x0000, 0x1800, 0x1800, 0xFF00, 0xFF00, 0x1800, 0x1800, 0x0000}, // '+'
//     {0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x3C00, 0x3C00, 0x0C00, 0x1800, 0x0000}, // ','
//     {0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xFF00, 0xFF00, 0x0000, 0x0000, 0x0000}, // '-'
//     {0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x7C00, 0x7C00, 0x0000, 0x0000, 0x0000}, // '.'
//     {0x0000, 0x0000, 0x0300, 0x0600, 0x0C00, 0x1800, 0x3000, 0x6000, 0xC000, 0x0000}, // '/'
...
//     {0x0000, 0xFF00, 0xFF00, 0x0300, 0x0600, 0x0C00, 0x1800, 0x3000, 0xFF00, 0xFF00}, // 'Z'
//     {0x0000, 0x7E00, 0x6000, 0x6000, 0x6000, 0x6000, 0x6000, 0x6000, 0x7E00, 0x0000}, // '['
//     {0x0000, 0xC000, 0x6000, 0x3000, 0x1800, 0x0C00, 0x0600, 0x0300, 0x0000, 0x0000}, // '\'
//     {0x0000, 0x7E00, 0x0600, 0x0600, 0x0600, 0x0600, 0x0600, 0x0600, 0x7E00, 0x0000}, // ']'
//     {0x0000, 0x1800, 0x3C00, 0x6600, 0xC300, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000}, // '^'
//     {0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xFF00, 0xFF00}, // '_'
//     {0x0000, 0x3000, 0x1800, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000}, // '`'
//     {0x0000, 0x0000, 0x0000, 0x7E00, 0x7E00, 0x0600, 0x7E00, 0xCE00, 0x7E00, 0x0000}, // 'a'
//     {0x0000, 0xC000, 0xC000, 0xFC00, 0xFE00, 0xC300, 0xC300, 0xC300, 0xFE00, 0xFC00}, // 'b'
//     {0x0000, 0x0000, 0x0000, 0x7E00, 0xFF00, 0xC300, 0xC000, 0xC300, 0xFF00, 0x7E00}, // 'c'
//     {0x0000, 0x0300, 0x0300, 0x7F00, 0xFF00, 0xC300, 0xC300, 0xC300, 0xFF00, 0x7F00}, // 'd'
//     {0x0000, 0x0000, 0x0000, 0x7E00, 0xFF00, 0xC300, 0xFE00, 0xFE00, 0x7E00, 0x0000}, // 'e'
//     {0x0000, 0x3C00, 0x6600, 0x6000, 0xFC00, 0xFC00, 0x6000, 0x6000, 0x6000, 0x0000}, // 'f'
//     {0x0000, 0x0000, 0x7E00, 0xFF00, 0xC300, 0xC300, 0x7F00, 0xFF00, 0x0300, 0xFE00}, // 'g'
//     {0x0000, 0xC000, 0xC000, 0xFC00, 0xFE00, 0xC300, 0xC300, 0xC300, 0xC300, 0x0000}, // 'h'
//     {0x0000, 0x1800, 0x0000, 0x1800, 0x7E00, 0x7E00, 0x1800, 0x7E00, 0x7E00, 0x0000}, // 'i'
//     {0x0000, 0x0C00, 0x0000, 0x0C00, 0x0C00, 0x0C00, 0x0C00, 0xCC00, 0xCC00, 0x7E00}, // 'j'
//     {0x0000, 0xC000, 0xC000, 0xC300, 0xC600, 0xDC00, 0xF800, 0xDC00, 0xC600, 0xC300}, // 'k'
//     {0x0000, 0x1800, 0x1800, 0x1800, 0x1800, 0x1800, 0x1800, 0x7E00, 0x7E00, 0x0000}, // 'l'
//     {0x0000, 0x0000, 0x0000, 0xF600, 0xFF00, 0xDB00, 0xDB00, 0xDB00, 0xC300, 0x0000}, // 'm'
//     {0x0000, 0x0000, 0x0000, 0xFC00, 0xFE00, 0xC300, 0xC300, 0xC300, 0xC300, 0x0000}, // 'n'
//     {0x0000, 0x0000, 0x0000, 0x7E00, 0xFF00, 0xC300, 0xC300, 0xC300, 0xFF00, 0x7E00}, // 'o'
//     {0x0000, 0x0000, 0x0000, 0xFC00, 0xFE00, 0xC300, 0xC300, 0xC300, 0xFE00, 0xFC00}, // 'p'
//     {0x0000, 0x0000, 0x0000, 0x7E00, 0xFF00, 0xC300, 0xC300, 0xC300, 0xFF00, 0x7F00}, // 'q'
//     {0x0000, 0x0000, 0x0000, 0xDB00, 0xFF00, 0xF700, 0xC000, 0xC000, 0xC000, 0x0000}, // 'r'
//     {0x0000, 0x0000, 0x0000, 0x7E00, 0xFF00, 0xC000, 0x7E00, 0x0300, 0xFF00, 0x7E00}, // 's'
//     {0x0000, 0x1800, 0x1800, 0x7E00, 0x7E00, 0x1800, 0x1800, 0x1800, 0x3C00, 0x0000}, // 't'
//     {0x0000, 0x0000, 0x0000, 0xC300, 0xC300, 0xC300, 0xC300, 0xC300, 0xFF00, 0x7E00}, // 'u'
//     {0x0000, 0x0000, 0x0000, 0xC300, 0xC300, 0x6600, 0x6600, 0x3C00, 0x1800, 0x0000}, // 'v'
//     {0x0000, 0x0000, 0x0000, 0xC300, 0xC300, 0xDB00, 0xDB00, 0xFF00, 0x6600, 0x0000}, // 'w'
//     {0x0000, 0x0000, 0x0000, 0xC300, 0x6600, 0x3C00, 0x3C00, 0x6600, 0xC300, 0x0000}, // 'x'
//     {0x0000, 0x0000, 0x0000, 0xC300, 0xC300, 0x7F00, 0x0300, 0xC300, 0xFF00, 0x7E00}, // 'y'
//     {0x0000, 0x0000, 0x0000, 0xFF00, 0xFF00, 0x0600, 0x1C00, 0x3000, 0xFF00, 0xFF00}, // 'z'
//     {0x0000, 0x1E00, 0x3000, 0x3000, 0x3000, 0xE000, 0x3000, 0x3000, 0x3000, 0x1E00}, // '{'
//     {0x0000, 0x7E00, 0x7E00, 0x1800, 0x1800, 0x1800, 0x1800, 0x7E00, 0x7E00, 0x0000}, // '|'
//     {0x0000, 0x7800, 0x0C00, 0x0C00, 0x0C00, 0x1E00, 0x0C00, 0x0C00, 0x0C00, 0x7800}, // '}'
//     {0x0000, 0x6600, 0xFF00, 0xDB00, 0xDB00, 0xC300, 0x0000, 0x0000, 0x0000, 0x0000}, // '->'
//     {0x0000, 0x6600, 0xFF00, 0xDB00, 0xDB00, 0xFF00, 0x6600, 0x0000, 0x0000, 0x0000}  // '<-'
// };
...
// void hardwareRst() {
//   PORTB = SetBit(PORTB, 1, 0); // set rst pin to low
//   _delay_ms(200);
//   PORTB = SetBit(PORTB, 1, 1);// set rst pin to high
//   _delay_ms(200); 
// }

// void command(char command) { // sends the command to the display. This tells the LCD what its next instructions are (pg.77-8)
...
// void data(char dat) { // sends that data that will be written to the LCD
//   PORTB = SetBit(PORTB, AO, 1); // AO = on
//   PORTB = SetBit(PORTB, CS, 0); // cs = off
//   SPI_SEND(dat); // send the command
//   PORTB = SetBit(PORTB, CS, 1); // cs = on
// }
...
// void ST7735_Init() { // init the display
//   hardwareRst();
//   SPI_SEND(0x01);
//   _delay_ms(150);
//   SPI_SEND(0x11);
...
const uint16_t font[96][10] = {
    {0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000}, // ' ' (space)
    {0x0000, 0x0000, 0x1800, 0x1800, 0x1800, 0x1800, 0x1800, 0x0000, 0x1800, 0x0000}, // '!'
    {0x0000, 0x6600, 0x6600, 0x6600, 0x6600, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000}, // '"'
    {0x0000, 0x3600, 0x3600, 0xFF00, 0x3600, 0xFF00, 0x3600, 0x3600, 0x0000, 0x0000}, // '#'
    {0x0000, 0x1800, 0x7E00, 0xC300, 0xC000, 0x7E00, 0x0300, 0xC300, 0x7E00, 0x1800}, // '$'
    {0x0000, 0x0000, 0xC600, 0xCC00, 0x1800, 0x3000, 0x6600, 0xC600, 0x0000, 0x0000}, // '%'
    ...
    {0x0000, 0x1800, 0x3000, 0x6000, 0x6000, 0x6000, 0x6000, 0x3000, 0x1800, 0x0000}, // '('
    {0x0000, 0x6000, 0x3000, 0x1800, 0x1800, 0x1800, 0x1800, 0x3000, 0x6000, 0x0000}, // ')'
    {0x0000, 0x1000, 0x5400, 0x3800, 0x7C00, 0x3800, 0x5400, 0x1000, 0x0000, 0x0000}, // '*'
    {0x0000, 0x0000, 0x0000, 0x1800, 0x1800, 0xFF00, 0xFF00, 0x1800, 0x1800, 0x0000}, // '+'
    {0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x3C00, 0x3C00, 0x0C00, 0x1800, 0x0000}, // ','
    {0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xFF00, 0xFF00, 0x0000, 0x0000, 0x0000}, // '-'
    {0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x7C00, 0x7C00, 0x0000, 0x0000, 0x0000}, // '.'
...
// const uint16_t largerFont[96][10] = {
//     {0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000}, // ' ' (space)
//     {0x0000, 0x0000, 0x1800, 0x1800, 0x1800, 0x1800, 0x1800, 0x0000, 0x1800, 0x0000}, // '!'
//     {0x0000, 0x6600, 0x6600, 0x6600, 0x6600, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000}, // '"'
//     {0x0000, 0x3600, 0x3600, 0xFF00, 0x3600, 0xFF00, 0x3600, 0x3600, 0x0000, 0x0000}, // '#'
...
void displayUpMan()   { return; }
void displayDownMan() { return; }
